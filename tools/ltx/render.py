...
ap.add_argument('--reseed', type=int, default=0, help='add to the seed of every shot rendered (a fresh roll)')
args = ap.parse_args()
...
STYLE = 'Single continuous take, no cuts, the same room throughout. Painted 1940s film noir, oil on canvas, muted earthy palette, deep shadows, soft film grain.'
# shot -> (still, frames, what moves). (n-1) % 8 == 0: 73 = 3 s, 121 = 5 s at 24 fps.
SHOTS = {
  'squad': ('squad3.jpg', 121, 'The detectives stay seated at the table under the lamp for the whole shot. Cigarette smoke drifts slowly upward. One of them turns a page; another looks up toward the door. Rain streaks the window behind. Static camera, no camera movement, the detectives remain in frame throughout.'),
  ...
  'burst': ('burst.jpg', 73, 'The door is flung open and the sergeant bursts through it into the smoky room, breathless, hat in hand, light from the corridor spilling across the floor behind him. The camera holds on the doorway for the whole shot, static, no cuts.'),
  ...
  'tell-salt':   ('tell-salt.jpg', 121, 'The woman sergeant leans on the table and talks urgently, out of breath, eyes on the viewer, one hand gesturing as she speaks, lamp light on her face, the same grey wall behind her throughout. Static medium close-up, no cuts, no change of room.'),
...
NEG = 'pc game, console game, video game, cartoon, childish, ugly, text, watermark, bright daylight, extra people, morphing face, scene change, jump cut, cut to another room, new location, camera pan away'
