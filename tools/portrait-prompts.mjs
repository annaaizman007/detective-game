...
const CASTING = {
  ...
  // the Orchid
  vera: { extra: 'a nightclub singer with vivid copper red hair and red lipstick, in a buttoned dark velvet coat with a fur collar', hair: 'red', glam: true, neg: 'cleavage, bare shoulders, dress, lingerie, black hair, dark hair', seed: 4401 },
  ...
  boyle: { extra: 'a young 1940s British police constable, a tall dark rounded custodian helmet with a silver badge on his head, dark wool tunic with silver buttons, anxious face', hair: 'fair', neg: 'peaked cap, officer cap, bellhop, medals, armor, armour, knight, fantasy, steel helmet, visor, anime', seed: 4243 },
  ...
  quist: { extra: 'a young beat constable in a dark wool police tunic and a tall dark custodian helmet with a silver badge, earnest', hair: 'dark', neg: 'peaked cap, officer cap, anime, glamour' },
