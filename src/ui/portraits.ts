...
const LOOKS: Record<string, Partial<Look>> = {
  ...
  hendriks: { fem: false, age: 1, hair: 2, hat: 3, beard: 1, coat: 4, collar: 2, mood: 2 },
  harris: { fem: false, age: 0, hair: 1, hat: 0, beard: 0, coat: 6, collar: 1, mood: 3 },
  // The Lamplighter
  penhale: { fem: false, age: 2, hair: 1, hat: 0, beard: 0, coat: 2, collar: 2, mood: 2 },
  vane: { fem: false, age: 2, hair: 6, hat: 3, beard: 1, coat: 4, collar: 2, mood: 3 },
  rowe: { fem: false, age: 1, hair: 0, hat: 0, beard: 0, coat: 6, collar: 1, glasses: true, mood: 0 },
  leo: { fem: false, age: 1, hair: 0, hat: 6, beard: 1, coat: 3, collar: 0, mood: 2 },
  dunne: { fem: true, age: 2, hair: 4, hat: 5, coat: 0, collar: 0, mood: 0 },
  pask: { fem: false, age: 1, hair: 2, hat: 4, beard: 1, coat: 2, collar: 2, mood: 3 },
  klein: { fem: false, age: 1, hair: 1, hat: 0, beard: 0, coat: 6, collar: 1, glasses: true, mood: 3 },
  crowe: { fem: true, age: 2, hair: 4, hat: 0, coat: 1, collar: 1, mood: 2 },
  boyle: { fem: false, age: 0, hair: 1, hat: 4, beard: 0, coat: 2, collar: 2, mood: 3 },
  kilbride: { fem: true, age: 1, hair: 3, hat: 4, coat: 2, collar: 0, mood: 2 },
  dwyer: { fem: true, age: 0, hair: 3, hat: 0, coat: 1, collar: 1, mood: 3 },
  amos: { fem: false, age: 2, hair: 6, hat: 0, beard: 2, coat: 1, collar: 5, mood: 0 },
  gurney: { fem: false, age: 1, hair: 2, hat: 0, beard: 1, coat: 7, collar: 2, mood: 1 },
  nunn: { fem: false, age: 1, hair: 1, hat: 0, beard: 0, coat: 5, collar: 1, glasses: true, mood: 0 },
  aldridge: { fem: true, age: 1, hair: 4, hat: 0, coat: 3, collar: 1, mood: 1 },
  tench: { fem: true, age: 1, hair: 4, hat: 0, coat: 6, collar: 0, glasses: true, mood: 0 },
  halloway: { fem: false, age: 1, hair: 2, hat: 3, beard: 2, coat: 4, collar: 2, mood: 2 },
  wright: { fem: false, age: 2, hair: 6, hat: 3, beard: 2, coat: 1, collar: 2, mood: 0 },
  benedetti: { fem: true, age: 1, hair: 4, hat: 0, coat: 3, collar: 2, mood: 1 },
  ziegler: { fem: false, age: 2, hair: 6, hat: 0, beard: 0, coat: 6, collar: 1, glasses: true, mood: 0 },
  brace: { fem: true, age: 1, hair: 2, hat: 4, coat: 2, collar: 0, mood: 2 },
  lark: { fem: false, age: 1, hair: 0, hat: 6, beard: 1, coat: 3, collar: 0, mood: 1 },
  cobbett: { fem: false, age: 2, hair: 6, hat: 4, beard: 0, coat: 2, collar: 2, mood: 3 },
  rusk: { fem: false, age: 0, hair: 7, hat: 3, beard: 0, coat: 1, collar: 2, mood: 3 },
  frye: { fem: false, age: 1, hair: 2, hat: 0, beard: 0, coat: 5, collar: 1, mood: 0 },
  marlow: { fem: true, age: 1, hair: 4, hat: 0, coat: 6, collar: 0, glasses: true, mood: 0 },
  roper: { fem: true, age: 0, hair: 3, hat: 0, coat: 1, collar: 1, mood: 0 },
  hobden: { fem: false, age: 1, hair: 2, hat: 3, beard: 1, coat: 4, collar: 2, mood: 2 },
  kane: { fem: true, age: 1, hair: 4, hat: 0, coat: 0, collar: 1, mood: 3 },
  sayer: { fem: false, age: 2, hair: 6, hat: 0, beard: 0, coat: 6, collar: 1, glasses: true, mood: 0 },
  bird: { fem: false, age: 2, hair: 6, hat: 3, beard: 2, coat: 1, collar: 2, mood: 0 },
