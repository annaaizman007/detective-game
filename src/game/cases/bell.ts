...
const def: CaseDef = {
  ...
  suspects: [
    ...
    { id: 'driver', name: 'Rosalind Fay', role: 'Tram driver',
      ...
      topics: [
        { id: 'night', q: 'Car seven went out at a quarter to midnight.', a: 'It did. I was in bed. She looks away. No. I took it. I drove somebody up the hill with the lights off for five pounds and I have not been paid.' },
